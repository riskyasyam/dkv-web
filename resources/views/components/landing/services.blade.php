<section id="services" class="relative py-24">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="reveal mb-12 max-w-2xl">
            <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#E4572E]">Services</p>
            <h2 class="mt-3 font-display text-4xl font-black leading-tight sm:text-5xl">Creative Services Built for Impact</h2>
        </div>
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            @foreach ([
                ...
                ['icon' => '▣', 'title' => 'UI/UX', 'desc' => 'Wireframe, prototipe, dan antarmuka digital dengan pengalaman pengguna kuat.'],
            ] as $service)
